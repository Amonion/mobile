        ...
        renderItem={({ item }) => (
          <View style={{ width, height: '100%' }}>
            ...
            <TouchableOpacity
              ...
              className="items-start bg-black/50 px-3 py-1 rounded-[20px]"
            >
              {item.startAt && (
                <CountdownCell startingTime={getRemainingTime(item.startAt)} />
              )}
            </TouchableOpacity>
            ...
            >
              ...
              <View className="bg-black/50 px-3 py-1 rounded-[20px]">
                <Text
                  style={{
                    color: 'white',
                    fontSize: 16,
