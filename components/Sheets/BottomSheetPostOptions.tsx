...
interface BottomSheetPostOptionsProps {
  visible: boolean
  onClose: () => void
...
const BottomSheetPostOptions: React.FC<BottomSheetPostOptionsProps> = ({
  visible,
  onClose,
  children,
  height = 350,
  ...
  return (
    <Modal
      ...
      statusBarTranslucent // <-- important for Android transparency
      hardwareAccelerated
    >
...
export default BottomSheetPostOptions
